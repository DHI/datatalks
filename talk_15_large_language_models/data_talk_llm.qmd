...
models = ['ELIZA (MIT)', 'SHRDLU (MIT)', 'PARRY (Stanford)', 'R1 (Carnegie Mellon)', 'CYC (Cycorp)', 'ALICE (ALICE Foundation)', 'Siri (SRI and Apple)', 'Google Assistant (Google)', 'OpenAI GPT (OpenAI)', 'GitHub Copilot (Github and Microsoft)', 'ChatGPT (OpenAI)', 'Bard AI (Google)']
