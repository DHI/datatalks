...
:::: columns
::: {.column width=50%}
- **GPT**-like (Generative Pretrained Transformer) GPT-3.x or GPT-Neo (e.g. chatGPT, chatBCG) by **OpenAI**, >175 Billion parameters
...
::: footer
Links and sources: [intro 1](https://www.omegavp.com/articles/introduction-to-large-language-models/), [intro 2](https://huggingface.co/course/chapter1/4?fw=pt)
:::
